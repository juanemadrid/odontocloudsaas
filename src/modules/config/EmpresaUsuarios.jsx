        ...
        try {
            ...
            (uRes.data || []).forEach(u => {
                ...
                profilesMap.set(u.id, {
                    ...
                    registroMedico: detail.registroMedico || detail.tarjetaProfesional || u.registro_medico || "",
                    tarjetaProfesional: detail.registroMedico || detail.tarjetaProfesional || u.registro_medico || "",
                    firma: detail.firma || detail.firmaElectronica || u.firma || u.firma_url || "",
                    firmaElectronica: detail.firma || detail.firmaElectronica || u.firma || u.firma_url || "",
            ...
            (configUsersData || []).forEach(u => {
                ...
                profilesMap.set(u.id, {
                    ...
                    registroMedico: u.registroMedico || u.tarjetaProfesional || existing.registroMedico || "",
                    tarjetaProfesional: u.registroMedico || u.tarjetaProfesional || existing.registroMedico || "",
                    firma: u.firma || u.firmaElectronica || existing.firma || "",
                    firmaElectronica: u.firma || u.firmaElectronica || existing.firma || "",
